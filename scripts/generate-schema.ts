...
const outputPath = join(rootDir, 'oh-my-opencode-slim-f.schema.json');
...
const jsonSchema = {
  ...
  title: 'oh-my-opencode-slim-f',
  description:
    'Configuration schema for oh-my-opencode-slim-f plugin for OpenCode',
};
